      ...
      <CardContent className="space-y-4">
        ...
        {breakdown && (
          <div className="space-y-2 pt-2 border-t">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">BC Provincial Tax</span>
              <span className="text-red-600 dark:text-red-400">
            ...
            <div className="flex justify-between text-sm pt-1">
              ...
              <span>
                {((breakdown.totalTax / salaryNum) * 100).toFixed(1)}%
              </span>
            </div>
        ...
        {!breakdown && !isCurrentUser && !user.preferences?.annualSalary && (
          <p className="text-xs text-muted-foreground italic">
            Waiting for {user.displayName} to enter their salary.
          </p>
        )}
      </CardContent>
    </Card>
          ...
          <CardContent className="space-y-3">
            ...
            {breakdowns.length === 1 && budgetUsers.length > 1 && (
              <p className="text-xs text-muted-foreground text-center italic">
                Only showing one salary. Combined calculation will update when
                both salaries are entered.
              </p>
            )}
            ...
            <div className="rounded-lg border bg-muted/20 px-4 py-3">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Estimate based on BC + Federal income tax only. Does not
                  include CPP, EI, or other deductions. Actual take-home may be
                  lower.
                </p>
              </div>
            </div>
